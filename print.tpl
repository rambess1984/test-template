...
<title>Версия для печати &raquo; {title}</title>
...
.page {width:730px}
.speedbar {padding:0 0 0.5em;margin-bottom:1em;border-bottom:1px solid #737373;}
.info {font-size:80%;padding:0 0 0.5em;}
...
<body>
<div class="page">
	<p class="speedbar">Главная &raquo; {category} &raquo; {title}</p>

	<h1>{title}</h1>
	<p class="info">{date} Разместил: {login}</p>
	{full-story}
